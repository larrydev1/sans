    ...
    <header>
      <nav class="nav-header-main">
        ...
        <ul>
          ...
          <li><a href="mailto:larrydev1@outlook.com">Contact</a></li>
        </ul>
      </nav>
      <div class="header-login">
        ...
        if (!isset($_SESSION['id'])) {
          echo '<form action="includes/login.inc.php" method="post">
            <input type="text" name="mailuid" placeholder="E-mail address">
            <input type="password" name="pwd" placeholder="Use Birthdate MM/DD/YYYY">
